...
This folder contains repo-local planning for the first 30 days of launch and adoption work for **Info Security Analyzer**.

## Files

- [`weekly-execution-packet.md`](./weekly-execution-packet.md) — single operator-ready packet for this week, bundling the 7-day plan, asset pack, channel sequence, and posting guardrails into one working doc
...
- Lead with **trust and clarity**, not hype
- Show the product quickly with the built-in **demo report**
- Be explicit about **privacy boundaries** and **LLM limitations**
- Optimize for **stars, quality feedback, contributor interest, and repeat usage signals**
- Reuse one core launch story across channels, then adapt tone per audience
